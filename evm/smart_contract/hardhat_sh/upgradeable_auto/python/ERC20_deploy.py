...
if __name__ == "__main__":
    ...
    tokenType = "ERC20"
    targetTokenName = "Artcoin"
    targetSymbolName = "ARTC"
    targetAmount = 10000000000

    retCode, retMessage, abiData, contractAddress, contractTransactionHash = polygon_deploy_contract(network, rpcUrlKey, etherscanKey, ownerPK, tokenType, targetTokenName, targetSymbolName, targetAmount, logger, python_pgm)
